  ...
  return (
    <div className="space-y-6">
      <div className="text-center space-y-3">
        <div className="inline-flex items-center justify-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-yellow-500/10 to-orange-500/10 border border-yellow-500/20">
          <Crown className="h-5 w-5 text-yellow-500 animate-pulse" />
          <span className="font-display font-semibold text-sm">Premium Features</span>
        ...
        {premiumFeatures.map((feature) => {
          ...
          return (
            ...
            >
              ...
              <div className={cn(
                "absolute top-4 right-4 w-8 h-8 rounded-full bg-background/80 backdrop-blur-sm flex items-center justify-center border border-border/50 transition-all duration-300",
                isHovered && "scale-110"
              )}>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-1">
                      <h3 className="font-display font-semibold">{feature.name}</h3>
                      <Badge 
                        variant="outline" 
                        className={cn(
                          "text-xs",
      ...
      {/* CTA Section */}
      <Card className="glass-card p-8 text-center space-y-4 border-2 border-primary/20">
        <div className="inline-flex items-center justify-center gap-2 px-4 py-2 rounded-full bg-primary/10 mb-2">
