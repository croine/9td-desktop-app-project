                ...
                <AnimatePresence mode="wait">
                  {isLoadingView ? (
                    ...
                    <PageContainer key={currentView}>
                      ...
                      {currentView === 'shoutbox' && (
                        !session?.user ? (
                          <ProtectedViewPlaceholder viewName="Shoutbox" />
                        ) : (
                          <div className="space-y-6">
                            <div>
                              <h1 className="font-display text-3xl font-bold mb-2">💬 Shoutbox</h1>
                              <p className="text-foreground/70 font-medium">
                                Live chat feed for quick updates and team communication
                              </p>
                            </div>
                            <Shoutbox />
                          </div>
